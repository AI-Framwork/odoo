...
For now, configuration code is in crossnow.tools.config. It is in mainly
...
To initialize properly this module, crossnow.tools.config.parse_config()
must be used.

"""

# Paths to search for CrossNow addons.
addons_paths = []
...
# installed (i.e. the majority of CrossNow addons). This is set with the --load
# command-line option.
server_wide_modules = []
