...
import crossnow
from crossnow.sql_db import db_connect, TestCursor
from crossnow.tests import common
from crossnow.tests.common import BaseCase
from crossnow.tools.misc import config

ADMIN_USER_ID = common.ADMIN_USER_ID

def registry():
    return crossnow.registry(common.get_db_name())
...
class TestTestCursor(common.TransactionCase):
    def setUp(self):
        ...
        self.env = crossnow.api.Environment(self.cr, crossnow.SUPERUSER_ID, {})
    ...
    def test_interleaving(self):
        ...
        with self.assertLogs('crossnow.sql_db', level=logging.WARNING) as cm:
            a.close()
        [msg] = cm.output
        self.assertIn('WARNING:crossnow.sql_db:Found different un-closed cursor', msg)
