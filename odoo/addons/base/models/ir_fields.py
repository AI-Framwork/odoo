...
from crossnow import api, Command, fields, models, _
from crossnow.tools import ustr, OrderedSet
from crossnow.tools.translate import code_translations, _lt
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an crossnow
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`crossnow.osv.orm.Model.write` expects.

        :param model: :class:`crossnow.osv.orm.Model` for the conversion base
        :param fromtype:
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`crossnow.fields.Field`
