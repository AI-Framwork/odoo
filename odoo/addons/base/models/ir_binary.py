...
from crossnow.exceptions import MissingError, UserError
from crossnow.http import Stream, request
from crossnow.tools import file_open, replace_exceptions
from crossnow.tools.image import image_process, image_guess_size_from_field_name
from crossnow.tools.mimetypes import guess_mimetype, get_extension
...
class IrBinary(models.AbstractModel):
    ...
    def _get_stream_from(
        ...
        """
        Create a :class:crossnow.http.Stream: from a record's binary field.
    ...
    def _get_image_stream_from(
        ...
        :meth:`~crossnow.models.BaseModel._get_placeholder_filename` which
        ...
        accordingly. See also :func:`crossnow.tools.image.image_process`.
