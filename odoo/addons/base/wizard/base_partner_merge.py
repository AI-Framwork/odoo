...
from crossnow import api, fields, models, Command
from crossnow import SUPERUSER_ID, _
from crossnow.exceptions import ValidationError, UserError
from crossnow.tools import mute_logger

_logger = logging.getLogger('crossnow.addons.base.partner.merge')
    ...
    def _update_foreign_keys(self, src_partners, dst_partner):
        ...
        for table, column in relations:
            ...
            if len(columns) <= 1:
                ...
                try:
                    with mute_logger('crossnow.sql_db'), self._cr.savepoint():
