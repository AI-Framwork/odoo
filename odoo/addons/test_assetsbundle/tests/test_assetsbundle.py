...
import crossnow
from crossnow import api, http
from crossnow.addons import __path__ as ADDONS_PATH
from crossnow.addons.base.models.assetsbundle import AssetsBundle, ANY_UNIQUE
from crossnow.addons.base.models.ir_asset import AssetPaths
from crossnow.addons.base.models.ir_attachment import IrAttachment
from crossnow.modules.module import get_manifest
from crossnow.tests import HttpCase, tagged
from crossnow.tests.common import TransactionCase
from crossnow.addons.base.models.ir_qweb import QWebException
from crossnow.tools import mute_logger, func
...
class TestAddonPaths(TransactionCase):
    def test_operations(self):
        ...
        asset_paths.append([
            ('/home/user/crossnow/addons/web/a', '/web/a', 1),
            ('/home/user/crossnow/addons/web/c', '/web/c', 1),
            ('/home/user/crossnow/addons/web/d', '/web/d', 1),
        ], 'bundle1')
        self.assertEqual(asset_paths.list, [
            ('/home/user/crossnow/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/d', '/web/d', 'bundle1', 1),
        ])

        # append with a duplicate of 'c'
        asset_paths.append([
            ('/home/user/crossnow/addons/web/c', '/web/c', 1),
            ('/home/user/crossnow/addons/web/f', '/web/f', 1),
        ], 'bundle2')
        self.assertEqual(asset_paths.list, [
            ('/home/user/crossnow/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'c' after 'c'
        asset_paths.insert([
            ('/home/user/crossnow/addons/web/c', '/web/c', 1),
            ('/home/user/crossnow/addons/web/e', '/web/e', 1),
        ], 'bundle3', 3)
        self.assertEqual(asset_paths.list, [
            ('/home/user/crossnow/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/crossnow/addons/web/f', '/web/f', 'bundle2', 1),
        ])

        # insert with a duplicate of 'd' before 'd'
        asset_paths.insert([
            ('/home/user/crossnow/addons/web/b', '/web/b', 1),
            ('/home/user/crossnow/addons/web/d', '/web/d', 1),
        ], 'bundle4', 1)
        self.assertEqual(asset_paths.list, [

            ('/home/user/crossnow/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/b', '/web/b', 'bundle4', 1),
            ('/home/user/crossnow/addons/web/c', '/web/c', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/d', '/web/d', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/e', '/web/e', 'bundle3', 1),
            ('/home/user/crossnow/addons/web/f', '/web/f', 'bundle2', 1),
        ...
        asset_paths.remove([
            ('/home/user/crossnow/addons/web/c', '/web/c', 1),
            ('/home/user/crossnow/addons/web/d', '/web/d', 1),
            ('/home/user/crossnow/addons/web/g', '/web/g', 1),
        ], 'bundle5')
        self.assertEqual(asset_paths.list, [
            ('/home/user/crossnow/addons/web/a', '/web/a', 'bundle1', 1),
            ('/home/user/crossnow/addons/web/b', '/web/b', 'bundle4', 1),
...
class AddonManifestPatched(TransactionCase):
    def setUp(self):
        ...
        self.patch(crossnow.modules.module, '_get_manifest_cached', Mock(side_effect=lambda module: self.manifests.get(module, {})))
...
class TestAssetsManifest(AddonManifestPatched):
    ...
    @mute_logger('crossnow.addons.base.models.ir_asset')
    def test_31(self):
...
class TestErrorManagement(HttpCase):
    ...
    def test_assets_bundle_css_error_backend(self):
        ...
        with mute_logger('crossnow.addons.base.models.assetsbundle'):
