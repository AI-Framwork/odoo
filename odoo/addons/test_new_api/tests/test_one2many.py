...
class One2manyCase(TransactionCase):
    ...
    @mute_logger('crossnow.osv.expression')
    def test_create_one2many_with_unsearchable_field(self):
        # crossnow.osv.expression is muted as reading a non-stored and unsearchable field will log an error and makes the runbot red
