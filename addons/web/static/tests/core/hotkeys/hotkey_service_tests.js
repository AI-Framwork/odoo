...
import { Component, useRef, useState, xml } from "@crossnow/owl";
...
QUnit.test("hotkey handles wrongly formed KeyboardEvent", async (assert) => {
    ...
    // fake error service so that the crossnow qunit handlers don't think that they need to handle the error
