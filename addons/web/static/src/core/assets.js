...
import { Component, xml, onWillStart, App } from "@crossnow/owl";
...
assets.loadBundle = async function loadBundle(desc) {
    ...
    crossnow.loader.checkAndReportErrors();
};
 ...
 */
export const templates = new DOMParser().parseFromString("<crossnow/>", "text/xml");
/**
