...
import { Component, useRef, useSubEnv } from "@crossnow/owl";
 ...
 * It uses a feature to automatically create links to other crossnow pages if the selector [res-id][res-model][view-type]
 * is detected.
 */
