 ...
 * functionalities with the crossnow framework.  A common theme in these functions
...
const dom = Object.assign({}, minimalDom, {
    ...
    /**
     * Renders a button with standard crossnow template. This does not use any xml
