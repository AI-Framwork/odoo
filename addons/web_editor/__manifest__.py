...
""",
    ...
    'assets': {
        ...
        'web_editor.wysiwyg_iframe_editor_assets': [
            ...
            # crossnow-editor
            'web_editor/static/src/js/editor/crossnow-editor/src/utils/utils.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/deleteForward.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/enter.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/shiftEnter.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/shiftTab.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/tab.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/toggleList.js',

            # crossnow utils
            'web_editor/static/src/scss/bootstrap_overridden.scss',
            'web/static/src/scss/pre_variables.scss',
            'web/static/lib/bootstrap/scss/_variables.scss',
            'web_editor/static/src/js/editor/crossnow-editor/src/style.scss',
        ...
        'web_editor.assets_tests_styles': [
            ('include', 'web._assets_helpers'),
            'web_editor/static/src/js/editor/crossnow-editor/src/base_style.scss',
            'web_editor/static/src/js/editor/crossnow-editor/src/checklist.scss',
        ],
        'web_editor.assets_wysiwyg': [
            ...
            # crossnow-editor
            'web_editor/static/src/js/editor/crossnow-editor/src/OdooEditor.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/utils/constants.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/utils/sanitize.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/utils/serialize.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/tablepicker/TablePicker.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/powerbox/patienceDiff.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/powerbox/Powerbox.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/align.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/commands.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/deleteBackward.js',
            'web_editor/static/src/js/editor/crossnow-editor/src/commands/deleteForward.js',
        ...
        "web.assets_web_dark": [
            'web_editor/static/src/scss/crossnow-editor/powerbox.dark.scss',
            'web_editor/static/src/scss/crossnow-editor/tablepicker.dark.scss',
            'web_editor/static/src/scss/crossnow-editor/tableui.dark.scss',
        ...
        'web.qunit_suite_tests': [
            ...
            'web_editor/static/src/js/editor/crossnow-editor/test/utils.js'
        ],
        'web_editor.mocha_tests': [
            ...
            'web_editor/static/src/js/editor/crossnow-editor/src/**/*js',
            'web_editor/static/src/js/editor/crossnow-editor/test/spec/*js',
            'web_editor/static/src/js/editor/crossnow-editor/test/*js',
        ],
    },
    'auto_install': True,
    'license': 'LGPL-3',
