...
patch(Wysiwyg.prototype, {
    ...
    _loadIframe() {
        ...
        this.$editable = $('<div class="note-editable oe_structure crossnow-editor-editable"></div>');
        this.$el.removeClass('note-editable oe_structure crossnow-editor-editable');
        if (isEditableRoot) {
        ...
        var def = new Promise(function (resolve) {
            window.top[self._onUpdateIframeId] = function (_avoidDoubleLoad) {
                ...
                const $iframeWrapper = $('<div class="iframe-editor-wrapper crossnow-editor">');
...
function getWysiwygIframeContent(params) {
    ...
    return `
        ...
        <script type="text/javascript">
            crossnow.define('root.widget', ['@web/legacy/js/core/widget'], function (require) {
                'use strict';
    ...
    <body class="o_in_iframe">
        ...
        <script type="text/javascript">
            crossnow.define('web_editor.wysiwyg.iniframe', [], function (require) {
                'use strict';
